...
const Landing = () => (
  <div className="min-h-screen bg-gray-50">
    ...
    {/* Hero Section */}
    <main className="relative overflow-hidden bg-cover bg-center bg-no-repeat" style={{backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url("https://images.pexels.com/photos/106399/pexels-photo-106399.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop")'}}>
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* All your existing property cards here - keeping exactly as they are */}
          {/* Property 1 */}
          ...
          {/* Copy all your other property cards here exactly as they are */}
          {/* I'm shortening this for brevity, but include ALL your property cards */}
        </div>
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600">Account Status: <span className="font-medium">{user.isVerified ? 'Verified' : 'Unverified'}</span></p>
