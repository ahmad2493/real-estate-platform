...
const ManageAgents = () => {
  ...
  const handleStatusUpdate = async (agentId, status) => {
    try {
      setUpdating(true);
      await api.patch(`/admin/agents/${agentId}/approve`, { status });
      ...
      toast.error(`Failed to ${status} agent application`);
    } finally {
      setUpdating(false);
    }
  };
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        {[
          ...
          { label: 'Pending', value: agents.filter(a => a.status === 'pending').length, color: 'yellow' },
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search by name, email, license number, or agency..."
                value={searchTerm}
                ...
                {filteredAgents.map((agent) => (
                  <tr key={agent._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-sm text-gray-500">{agent.agency || 'N/A'}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex flex-wrap gap-1">
                        ...
                        {agent.specializations?.length > 2 && (
                          <span className="text-xs text-gray-500">+{agent.specializations.length - 2} more</span>
                        )}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{selectedAgent.licenseNumber || 'Not provided'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{selectedAgent.agency || 'Not provided'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{selectedAgent.phone || 'Not provided'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{selectedAgent.experience || 'Not provided'}</p>
                  </div>
              ...
              <div className="text-sm text-gray-500">
                Applied on: {new Date(selectedAgent.createdAt).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric',
                  hour: '2-digit',
          ...
          <div className="bg-white rounded-lg max-w-md w-full">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                ...
                {actionType === 'approve' 
                  ? ' They will be notified and can start using the platform.'
              ...
              <div className="flex space-x-3">
                ...
                <button
                  onClick={() => handleStatusUpdate(actionAgent._id, actionType === 'approve' ? 'approved' : 'rejected')}
